  ...
  if (!loaded || !payload) {
    return (
      <section className="mx-auto max-w-7xl px-4 pb-8">
        <div className="rounded-xl border border-forest/20 bg-[#F0F9F4] p-6 lg:flex lg:items-center lg:justify-between">
          <div>
          ...
          <div className="mt-4 flex gap-3 lg:mt-0 lg:flex-col lg:items-end">
            <Link
              ...
              className="inline-flex min-h-11 items-center rounded-lg bg-forest px-5 text-sm font-bold text-white"
            >
              View Passport
            </Link>
            <Link
              href="/account/discovery"
              className="inline-flex min-h-11 items-center rounded-lg border border-forest/25 px-5 text-sm font-semibold text-forest"
            >
              Flavour Passport
            </Link>
          </div>
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 pb-8">
      <div className="mb-4 flex items-center justify-between">
        <h2 className="text-xl font-bold text-charcoal">Your Passport Progress</h2>
        <Link href="/account/passport" className="text-sm font-semibold text-forest hover:underline">
          View full passport →
        </Link>
      </div>
