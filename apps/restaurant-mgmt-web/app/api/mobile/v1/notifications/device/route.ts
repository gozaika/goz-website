...
/**
 * Register / deregister this device's push token (Slice 16) for the partner app.
 * Per-profile (not restaurant-scoped), backed by `notification_device`
 * (push_token unique). Mirrors the customer BFF device route.
 */
