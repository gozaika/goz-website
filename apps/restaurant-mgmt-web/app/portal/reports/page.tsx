    ...
    <PortalChrome restaurantName={restaurant.restaurantName} statusCode="ACTIVE">
      <section className="mx-auto max-w-7xl px-4 py-6 sm:px-6">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.18em] text-[#1A5C38]">Partner report</p>
          ...
          <Link className="min-h-11 rounded-lg border border-[#1A5C38]/25 px-4 py-3 text-sm font-semibold text-[#1A5C38]" href="/portal/finance">
            Finance
          </Link>
        </div>

        <form className="mt-5 grid gap-3 rounded-lg border border-black/10 bg-white p-4 sm:grid-cols-[1fr_1fr_auto]" action="/portal/reports">
        ...
        <section className="mt-5 rounded-lg border border-[#D4A017]/40 bg-[#FFF8E6] p-4">
        ...
        {report.dropRows.length === 0 ? (
          ...
          <section className="mt-5 rounded-lg border border-black/10 bg-white p-4">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <p className="text-sm text-slate-500">Fresh {new Date(report.summary.dataFreshnessAt).toLocaleString("en-IN")}</p>
            </div>
        ...
        <section className="mt-5 grid gap-4 lg:grid-cols-2">
          ...
          <div className="rounded-lg border border-black/10 bg-white p-4">
            ...
            {report.noteRows.length === 0 ? (
              <p className="mt-2 text-sm text-slate-600">No incidents or refunds/debits are present for this period.</p>
            ) : (
