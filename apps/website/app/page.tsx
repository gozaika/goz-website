...
export default function HomePage(): React.ReactElement {
  ...
  return (
    <div>
      <section className="mx-auto grid max-w-screen-xl gap-8 px-4 py-16 md:grid-cols-2 md:px-6 lg:px-8 lg:py-24">
        <div className="space-y-5">
          <p className="text-sm font-semibold uppercase tracking-wide text-forest">
            {homeContent.hero.eyebrow}
          </p>
          <h1 className="text-5xl font-bold leading-tight text-gray900 md:text-6xl">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link
              href="#waitlist"
              className="inline-flex rounded-md bg-saffron px-5 py-3 text-sm font-semibold uppercase tracking-wide text-gray900 hover:opacity-90"
            >
              {homeContent.hero.primaryCta}
            </Link>
            <Link
              href="/how-it-works"
              className="inline-flex rounded-md border border-forest px-5 py-3 text-sm font-semibold text-forest hover:bg-forest hover:text-white"
            >
        ...
        <Card variant="featured" className="self-start">
          <Image
        ...
        <div className="mx-auto max-w-screen-xl px-4 md:px-6 lg:px-8">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            {homeContent.restaurantTeaser.stats.map((stat) => (
              <Card key={stat} variant="minimal" className="border-white/30 text-white">
      ...
      <section id="waitlist" className="mx-auto max-w-screen-xl px-4 py-16 md:px-6 lg:px-8">
