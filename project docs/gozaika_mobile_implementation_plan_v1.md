...
| D1 | Demo/presales readiness | U1-R4, X1 | In progress (D1a + D1b complete 2026-06-27) |
...
- Next: D1c drop-type/blind-bag art variants; D1d store-asset cards (reconcile with `.codex-artifacts/gozaika-polish-v2`); D1e Maestro demo-flow polish + capture manifest. **Recommended: start D1d in a fresh session** (large + overlaps the polish-v2 track).
