...
| D1 | Demo/presales readiness | U1-R4, X1 | D1a–D1e complete 2026-06-27; awaiting owner slice-D inspection before FF to `main` |
...
- **D1 complete (D1a–D1e), 2026-06-27 — awaiting owner manual inspection before fast-forward to `main`.** D1 was an imagery + demo-readiness slice (the seed was already data-rich): D1a mobile cuisine covers, D1b web cuisine art + shared resolver, D1c drop-type/blind-bag variants, plus an owner-directed cloud demo mojibake repair; D1d reconciled store assets with `gozaika-polish-v2` (handoff, not competing cards); D1e demo-flow polish + capture manifest. Branch `codex/mobile-ux-uplift/d1-demo-presales`; gate 7/7. Per the merge rule, merge to `main` (fast-forward) only after the owner's slice-D inspection.
