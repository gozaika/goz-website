...
| D1 | Demo/presales readiness | U1-R4, X1 | In progress (D1a + D1b + D1c complete 2026-06-27) |
...
- Next: D1d store-asset cards (reconcile with `.codex-artifacts/gozaika-polish-v2`); D1e Maestro demo-flow polish + capture manifest.
