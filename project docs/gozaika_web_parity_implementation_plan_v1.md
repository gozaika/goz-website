...
| Web W4 | Customer surface recomposition + F1 home rail | W2 | **In progress 2026-06-29** — 13 customer page surfaces tokenized + gate-enforced (Home w/ HeroBanner+CountdownChip+**F1 follow rail**, drop detail w/ CountdownChip, drops/restaurants/[slug] shells, checkout, orders, account+passport+discovery, swaad-club, consent, cities). Home browser-verified. **Remaining:** 3 large interactive client views — `drop-discovery-client.tsx`, `restaurant-directory-client.tsx`, `restaurant-detail-client.tsx`. |
