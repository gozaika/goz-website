...
- `apps/website`: This has been implemented. public launch website for discovery and partner intent.
...
- Website writes only to lead-intake tables (`website_waitlist_lead`, `website_contact_submission`, `website_partner_interest`).
