...
- Next uplift slice: **D1 Demo/presales readiness** (seed rich demo scenarios + assets so Maestro flows are sales/investor-ready, no fake claims). See the slice table in `project docs/gozaika-mobile-ux-uplift-analysis-v1.md` §A5.
